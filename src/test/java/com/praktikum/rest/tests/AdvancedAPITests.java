...
public class AdvancedAPITests extends BaseTest {
    ...
    public void testResponseHeadersValidation() {
        given()
                ...
                // .header("X-Powered-By", not(emptyOrNullString())) // Optional: Validate technology stack
                .header("Content-Encoding", equalTo("gzip")); // Validate compression (jika ada)
    }
    ...
    public void testUpdateUserWithPartialData() {
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .body("name", equalTo("Updated Name Only")) // Validate nama terupdate
    ...
    public void testCreateUserWithEmptyBody() {
        given()
                ...
                .post("/users")
                .then()
                .statusCode(201); // JSONPlaceholder accepts empty body (Behavior spesifik API ini)
    }
